...
function validateComFormulaireModifContrat() {
    ...
    var x1 = document.forms["ComFormulaireModifContrat"]["titre"].value;
    var x2 = document.forms["ComFormulaireModifContrat"]["frequence"].value;
    var x3 = document.forms["ComFormulaireModifContrat"]["rayon"].value;
    var x4 = document.forms["ComFormulaireModifContrat"]["datedebut"].value;
    var x5 = document.forms["ComFormulaireModifContrat"]["datefin"].value;
    var x6 = document.forms["ComFormulaireModifContrat"]["datereception"].value;
    var x7 = document.forms["ComFormulaireModifContrat"]["datevalidation"].value;
    var x8 = document.forms["ComFormulaireModifContrat"]["fichier"].value;
    var x9 = document.forms["ComFormulaireModifContrat"]["statut"].value;
    var x10 = document.forms["ComFormulaireModifContrat"]["region"].value;
    var x11 = document.forms["ComFormulaireModifContrat"]["tarif"].value;
    var x12 = document.forms["ComFormulaireModifContrat"]["duree"].value;

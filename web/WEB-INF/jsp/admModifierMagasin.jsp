<%-- 
    Document   : admModifierMagasin
    Created on : 6 janv. 2016, 12:47:07
    Author     : batchanou
--%>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading"> Modifier un Magasin</h2>
                    <hr class="primary">
                </div>
            </div>
        </div> <!-- Modal ajout -->
        <div class="modal-dialog" role="document">
            <div class="modal-content" >
                ...
                <div class="panel-body col-lg-12">  
                    <form action="/RegubClient/ModifDataMagasin" method="POST" role="form">
                        <div class="">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <label>Nom*:</label>
                                            <input type="text" name="nom" id="nom" class="form-control input-sm" placeholder="nom" value="<%=mag.getNom() %>"required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">            
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <label>Rue*:</label>
                                        <div class="form-group">
                                            <input type="text" name="addrLigne1" id="telephone" class="form-control input-sm" placeholder="rue" value="<%=mag.getAddrLigne1() %>" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="addrLigne2" id="ligne2" class="form-control input-sm" placeholder="facultatif" value="<%=mag.getAddrLigne2() %>" required>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>code postal*:</label>
                                            <input type="text" name="codepostal" id="codepostal" class="form-control input-sm" placeholder="code postal" value="<%=mag.getCodePostal() %>" required>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>Ville*:</label>
                                            <input type="text" name="ville" id="ville" class="form-control input-sm" placeholder="ville" value="<%=mag.getVille() %>" required>
                                        </div>
                                    </div>

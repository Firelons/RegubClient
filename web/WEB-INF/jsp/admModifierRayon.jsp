...
<%-- 
    ...
    Created on : 10 janv. 2016, 14:12:02
    Author     : projet
--%>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">  
                    <form action="modifierrayon" method="POST" role="form">
                        <input type="hidden" name="idRayon" value="${ray.getIdTypeRayon()}">
                        <div class="row">
                            <div class="col-xs-8 col-sm-8 col-md-8">
                                <div class="form-group">
                                    <label>Nom</label>
                                    <input type="text" name="libelle"  class="form-control input-sm col-lg-6-" placeholder="libelle" value="${ray.getLibelle()}"required>
